...
// APPLY NICE FONT AND SUBMIT ON ENTER - REMEMBER TO SWITCH TO TESTING BRANCH YUP
...
export default function Chat(props: Props) {
    ...
    const createPromptTrpc = api.prompt.create.useMutation({ onSuccess: (response: string | undefined) => response })
    ...
    return (
        <div className="h-full relative text-center flex-col flex items-center">
            ...
            <form onSubmit={(e) => void formSubmitHandler(e)} className="items-center fixed bottom-10 bg-black rounded-md gap-2 w-6/12 flex">
